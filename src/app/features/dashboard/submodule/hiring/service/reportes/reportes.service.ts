...
export class ReportesService {
   ...
   *
   * Los 409 no son fallos del sistema sino estados del proceso (todavía no tiene
   * contrato, le falta la fecha de ingreso…). El backend los devuelve con un
   * `message` legible que la vista muestra tal cual.
   */
